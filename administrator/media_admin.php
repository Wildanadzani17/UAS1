...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_5">
			...
			<a id="site-title" href="dashboard.html"><span>ADMINISTRATOR</span><br><span>E-Learning SMPN 1 Wanayasa</span></a>
		</div>
...
<nav id="topmenu">
	<div class="container_12 clearfix">
		<div class="grid_12">
			<ul id="mainmenu" class="sf-menu" rel="fluid">
				<li class="current"><a href="media_admin.php?module=home">Beranda</a></li>				
			</ul>
			<ul id="usermenu">				
				<li><a href="logout.php">Logout</a></li>
...
<footer id="bottom">
	<section class="container_12 clearfix">
			<center>Copyright &copy; 2017 <a href="#"> TUGAS BESAR PAW</a></center>
	</section>
</footer>
